...
3. Falls `LoginView.swift` fehlt: **File → New → File… → Swift File** → Name `LoginView` → Target ☑ Luckys Taxi Fahrer → Create → Inhalt einfügen.
4. Falls `HomeView.swift` fehlt: gleich mit Name `HomeView`.
